      ...
      <div className="bg-white text-gray-800">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Online Store Terms */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 1 - Online Store Terms</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
            ...
            {/* General Conditions */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 2 - General Conditions</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <ul className="text-gray-600 space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 3 - Accuracy, Completeness and Timeliness of Information</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 4 - Modifications to the Service and Prices</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <ul className="text-gray-600 space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 5 - Products or Services</h2>
            ...
            {/* Billing Accuracy */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 6 - Accuracy of Billing Information</h2>
              <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                <p className="text-gray-600 mb-4">
            ...
            {/* Optional Tools */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 7 - Optional Tools</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 mb-4">
            ...
            {/* Third-party Links */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 8 - Third-Party Links</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 mb-4">
            ...
            {/* User Comments */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 9 - User Comments and Feedback</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 10 - Personal Information</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 mb-4">
                  Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy, please see our Privacy Policy page.
                </p>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 11 - Errors, Inaccuracies and Omissions</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 mb-4">
            ...
            {/* Prohibited Uses */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 12 - Prohibited Uses</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 13 - Disclaimer of Warranties; Limitation of Liability</h2>
              <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                <p className="text-gray-600">
            ...
            {/* Severability */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 15 - Severability</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600">
            ...
            {/* Termination */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 16 - Termination</h2>
              <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                <p className="text-gray-600">
            ...
            {/* Entire Agreement */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 17 - Entire Agreement</h2>
              <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                <p className="text-gray-600">
            ...
            {/* Governing Law */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 18 - Governing Law</h2>
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 19 - Changes to Terms of Service</h2>
              <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                <p className="text-gray-600">
            ...
            {/* Contact Information */}
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">Section 20 - Contact Information</h2>
              <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                <p className="text-gray-600">
                  Questions about the Terms of Service should be sent to us at akxbrand@gmail.com
                </p>
